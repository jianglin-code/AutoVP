...
package com.android.internal.telephony.custommade;
...
public class SimulatedCommands extends BaseCommands
    ...
    public static final String FAKE_IMEI = SystemProperties.get("persist.ro.custommade.deviceinfo.imei");
    public static final String FAKE_IMEISV = SystemProperties.get("ro.custommade.phone.imeisv");
    ...
    public void getIMSIForApp(String aid, Message result) {
        resultSuccess(result, SystemProperties.get("persist.ro.custommade.deviceinfo.imei"));
    }
    ...
    public void getBasebandVersion (Message result) {
        ...
        resultSuccess(result, SystemProperties.get("ro.custommade.prop.ro.baseband"));
    }
    ...
    private CellInfoGsm getCellInfoGsm() {
        ...
        ArraySet<String> mAdditionalPlmns = new ArraySet<>();
        mAdditionalPlmns.add("12");
        mAdditionalPlmns.add("13");
        mAdditionalPlmns.add("14");
        // CellInfo
        p.writeInt(1);
        p.writeInt(1);
        p.writeInt(2);
        ...
        p.writeInt(950);
        p.writeInt(27);
        p.writeArraySet(mAdditionalPlmns);
        // CellSignalStrength
        p.writeInt(99);
        p.writeInt(0);
        p.writeInt(3);
