...
public class PackageParser {
    ...
    public static final int PARSE_IS_PREINSTALL = 1<<10;
    public static final int PARSE_IS_PREBUNDLED_DIR = 1<<11;
    ...
    private Package parseBaseApk(String apkPath, Resources res, XmlResourceParser parser, int flags,
        ...
        //add by dxs
        if ("com.netflix.ninja".equals(pkgName)){
            outError[0] = "Disable package " + pkgName;
            mParseError = PackageManager.INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME;
            return null;
        }

        if ("com.netflix.mediaclient".equals(pkgName)){
            int versionCMax=SystemProperties.getInt("persist.sys.netflixmax",1000000);
            if(pkg.mVersionCode>versionCMax){
                outError[0] = "Disable package " + pkgName + "or version " + pkg.mVersionCode;
                mParseError = PackageManager.INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME;
                return null;
            }
        }
